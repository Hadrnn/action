...
public class BotHeavyTankShooting : MonoBehaviour
{
    ...
    private BotHeavyTankMovement Body;
    ...
    void Start()
    {
        ...
        Body = GetComponent<BotHeavyTankMovement>();
    }
    ...
    public void Fire()
    {
        ...
        Body.counter = BotHeavyTankMovement.discret;
    }
}
