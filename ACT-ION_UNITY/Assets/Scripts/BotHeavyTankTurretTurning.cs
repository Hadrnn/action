...
public class BotHeavyTankTurretTurning : MonoBehaviour
{
    ...
    private void Start()
    {
        Gun = gameObject.GetComponentInParent<BotHeavyTankShooting>();
        teamNumber = gameObject.GetComponentInParent<BotHeavyTankMovement>().teamNumber;
    }
    void Update()
    {
        ...
        Vector3 GunPos = GetComponentInChildren<Transform>().Find("HeavyTankTurret").Find("FireTransform").position;
